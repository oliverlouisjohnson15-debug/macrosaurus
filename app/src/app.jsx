...
const CREATURES = [
  ...
  { id: 'noodon', name: 'Noodon', art: 'longneck', colors: crC('#5AA0E8', '#356fb0'), biome: 'carb', rarity: 'uncommon', cond: 'Carbs on point with fibre in range.', lore: 'A gentle long-neck woven from whole grains and good noodles. Surprisingly wise; will not be rushed.' },
  // Fat Flats
  { id: 'fatzilla', name: 'Fatzilla', art: 'saur', colors: crC('#F5C518', '#c99a10'), biome: 'fat', rarity: 'common', cond: 'Hit your healthy fats.', lore: 'Radiates a warm, oily glow and insists that avocados are, technically, a personality trait. Difficult to argue with.', evo: [{ at: 5, name: 'Fatlas', art: 'stego', colors: crC('#e6b910', '#b8890c') }, { at: 10, name: 'Fatalisk', art: 'rex', colors: crC('#d4a810', '#9e7a08') }] },
  ...
  { id: 'aurora', name: 'Aurora', art: 'trike', colors: crC('#7FE0E8', '#3f9ea8'), biome: 'mythic', rarity: 'mythic', cond: 'Roams only after a perfect week (5+ perfect days in 7).', lore: 'A shimmering wanderer said to trail the northern lights across the sky. A whole week of perfect days is the only thing that draws it near.' },
  { id: 'chronos', name: 'Chronos', art: 'rex', colors: crC('#FFD400', '#B8860B'), biome: 'mythic', rarity: 'mythic', cond: 'A 30-day streak crowned by a perfect day.', lore: 'Ancient keeper of streaks. It remembers every single day you showed up, and it rewards only the truly relentless.' },
